...
public class FixedAreaAction extends BaseAction<FixedArea> {
	...
	@Action(value = "findAll_fiexedArea", results = { @Result(type = "json", name = "success") })
	public String findAllFixedArea() {
		List<FixedArea> fixedAreaList = fixedAreaService.findAll();
		pushPageDataToValueStack(fixedAreaList);
		return SUCCESS;
	}
