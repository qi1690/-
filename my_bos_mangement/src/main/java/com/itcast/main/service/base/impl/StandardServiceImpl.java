...
import com.itcast.main.dao.base.StandardRepository;
...
public class StandardServiceImpl implements StandardService {
	...
	public Page<Standard> findPageData(Pageable pageable) {
		System.out.println("StandardServiceImpl findPageData="+pageable.getPageNumber()+" "+pageable.getPageSize());
	...
	public List<Standard> findAll() {
		System.out.println("StandardServiceImpl findAll...");
